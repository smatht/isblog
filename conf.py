...
BLOG_AUTHOR = "Matias Sticchi"  # (translatable)
BLOG_TITLE = "Matias G. Sticchi [Ingenieria de Software I]"  # (translatable)
...
BLOG_EMAIL = "matgs656@gmail.com"
BLOG_DESCRIPTION = "Blog hecho con Nikola (python) de Matias Sticchi destinado a la materia Ingenieria del Software I de la carrera Licenciatura en Sistemas de Informacion"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/stories/principal', 'Principal', 'icon-home'),
        ('/stories/sobre-mi', 'Sobre mi', 'icon-user'),
        ('/blog', 'Blog', 'icon-bold'),
        ('/categories/index.html', 'Tags', 'icon-tags'),
        ('/rss.xml', 'RSS', 'icon-rss'),
        ('https://twitter.com/smatht', 'Mi Twitter', 'icon-twitter'),
        ('https://github.com/smatht', 'Mi Repositorio Github', 'icon-github'),
        ('https://bitbucket.org/matts656', 'Mi Repositorio Bitbucket', 'icon-bitbucket'),
    ),
}

# Name of the theme to use.
# THEME = "bootstrap3-is1"
THEME = "zen"
...
# (translatable)
CONTENT_FOOTER = 'Contenido &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="http://getnikola.com" rel="nofollow">Nikola</a>         {license}'
